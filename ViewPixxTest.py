...
rectangle3 = psychopy.visual.rect.Rect(win, units ='cm', fillColor=[], fillColorSpace=None, pos=(2.5, -2), size=[5,5], ori=0.0, opacity=None, contrast=1.0, colorSpace='rgb')
rectangle4 = psychopy.visual.rect.Rect(win, units ='cm', fillColor=[], fillColorSpace=None, pos=(7.5, -2), size=[5,5], ori=0.0, opacity=None, contrast=1.0, colorSpace='rgb')
